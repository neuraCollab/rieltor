...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_navbar_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_navbar" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_vision_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_vision" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_properties" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_feature_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_navbar_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_navbar" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_vision_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_vision" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_properties" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_feature_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_navbar_links_order_idx" ON "pages_blocks_navbar_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_navbar_links_parent_id_idx" ON "pages_blocks_navbar_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_navbar_order_idx" ON "pages_blocks_navbar" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_navbar_parent_id_idx" ON "pages_blocks_navbar" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_navbar_path_idx" ON "pages_blocks_navbar" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_navbar_avatar_idx" ON "pages_blocks_navbar" USING btree ("avatar_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_vision_items_order_idx" ON "pages_blocks_vision_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vision_items_parent_id_idx" ON "pages_blocks_vision_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vision_order_idx" ON "pages_blocks_vision" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vision_parent_id_idx" ON "pages_blocks_vision" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_vision_path_idx" ON "pages_blocks_vision" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_properties_order_idx" ON "pages_blocks_properties" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_properties_parent_id_idx" ON "pages_blocks_properties" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_properties_path_idx" ON "pages_blocks_properties" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_feature_features_order_idx" ON "pages_blocks_feature_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_feature_features_parent_id_idx" ON "pages_blocks_feature_features" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_how_it_works_steps_order_idx" ON "pages_blocks_how_it_works_steps" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_how_it_works_steps_parent_id_idx" ON "pages_blocks_how_it_works_steps" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_how_it_works_order_idx" ON "pages_blocks_how_it_works" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_how_it_works_parent_id_idx" ON "pages_blocks_how_it_works" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_how_it_works_path_idx" ON "pages_blocks_how_it_works" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_navbar_links_order_idx" ON "_pages_v_blocks_navbar_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_navbar_links_parent_id_idx" ON "_pages_v_blocks_navbar_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_navbar_order_idx" ON "_pages_v_blocks_navbar" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_navbar_parent_id_idx" ON "_pages_v_blocks_navbar" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_navbar_path_idx" ON "_pages_v_blocks_navbar" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_navbar_avatar_idx" ON "_pages_v_blocks_navbar" USING btree ("avatar_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vision_items_order_idx" ON "_pages_v_blocks_vision_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vision_items_parent_id_idx" ON "_pages_v_blocks_vision_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vision_order_idx" ON "_pages_v_blocks_vision" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vision_parent_id_idx" ON "_pages_v_blocks_vision" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_vision_path_idx" ON "_pages_v_blocks_vision" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_properties_order_idx" ON "_pages_v_blocks_properties" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_properties_parent_id_idx" ON "_pages_v_blocks_properties" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_properties_path_idx" ON "_pages_v_blocks_properties" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_feature_features_order_idx" ON "_pages_v_blocks_feature_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_feature_features_parent_id_idx" ON "_pages_v_blocks_feature_features" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_how_it_works_steps_order_idx" ON "_pages_v_blocks_how_it_works_steps" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_how_it_works_steps_parent_id_idx" ON "_pages_v_blocks_how_it_works_steps" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_how_it_works_order_idx" ON "_pages_v_blocks_how_it_works" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_how_it_works_parent_id_idx" ON "_pages_v_blocks_how_it_works" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_how_it_works_path_idx" ON "_pages_v_blocks_how_it_works" USING btree ("_path");
